var promise = require('promise'),
	...
	columns = {
		...
		trips: ['route_id', 'service_id', 'trip_id', 'trip_headsign', 'block_id', 'trip_short_name', 'shape_id', 'direction_id'],
		stop_times: ['trip_id', 'arrival_time', 'departure_time', 'stop_id', 'stop_sequence'],
		routes: ['route_id', 'route_short_name', 'route_long_name', 'route_type', 'route_color', 'route_text_color', 'route_url'],
		simplified_stops: ['route_id', 'direction_id', 'stop_id', 'stop_sequence', 'stop_name', 'stop_lat', 'stop_lon'],
